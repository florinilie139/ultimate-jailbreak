/*  prochat.sma
*   tDk* - Studio
*   Pentru mai multe detalii despre acest plugin intra pe www.desprecs.ro
...
public plugin_init()
{
	...
	register_concmd("amx_leavelmao", "cmdLeave", ADMIN_KICK, "<tag> [tag] [tag] [tag]")
	register_concmd("amx_pauselmao", "cmdPause", ADMIN_CVAR, "- pause or unpause the game")
	register_concmd("amx_who", "cmdWho", ADMIN_ADMIN, "- displays who is on server")
	register_concmd("amx_cvarlmao", "cmdCvar", ADMIN_CVAR, "<cvar> [value]")
	register_concmd("amx_pluginslmao", "cmdPlugins", ADMIN_ADMIN)
	register_concmd("amx_moduleslmao", "cmdModules", ADMIN_ADMIN)
	register_concmd("amx_map", "cmdMap", ADMIN_MAP, "<mapname>")
	register_concmd("amx_cfglmao", "cmdCfg", ADMIN_CFG, "<filename>")
	register_concmd("amx_nick", "cmdNick", ADMIN_SLAY, "<name or #userid> <new nick>")
	register_clcmd("amx_rconlmao", "cmdRcon", ADMIN_RCON, "<command line>")
	register_clcmd("amx_showrconlmao", "cmdShowRcon", ADMIN_RCON, "<command line>")
...
public cmdBan(id, level, cid)
{
    ...
    chat_color(0,"!gADMIN!team %s!g: ban!team %s!g pentru!team %s!g minute. Motiv: (!team %s!g )", name, pl, minutes, reason)    
