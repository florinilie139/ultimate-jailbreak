...
public plugin_init()
{
	...
	register_concmd("item_drug_crack","CmdCrack")
	register_concmd("item_drug_heroin","CmdHeroin")
	register_concmd("item_drug_pcp","CmdPcp")
	register_concmd("item_drug_mushroom","CmdMushroom")
	register_concmd("item_drug_cocaine","CmdCocaine")
	register_concmd("item_drug_acid","CmdAcid")
