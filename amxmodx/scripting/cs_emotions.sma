...
{ 
   ...
   g_animMenu = menu_create("\y[DANS MENU] \d [CSmiLeFaCe]", "animMenuHandler") 
...
public removePlayerEnt (id)
{
	engfunc(EngFunc_RemoveEntity,g_playerData[id][ENT_CAM])
	g_playerData[id][ENT_CAM] = 0
	engfunc(EngFunc_RemoveEntity,g_playerData[id][ENT_ANIM])
	g_playerData[id][ENT_ANIM] = 0
	engfunc(EngFunc_RemoveEntity,g_playerData[id][ENT_MODEL])
	g_playerData[id][ENT_MODEL] = 0
}
...
{ 
	...
	if(g_playerData[id][ANIM_PLAYING])
		stopAnim(id)
	startAnim(id, item) 
